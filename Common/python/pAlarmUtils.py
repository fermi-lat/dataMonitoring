...
## @var ACD_SIDE_ROW_2_NORM_FACTOR
## @brief Normalization factor for the @ref ACD_ACD_SIDE_ROW_2 group.
#  Used as a multiplicative factor for the alarm limits.

## @var ACD_SIDE_ROW_3_NORM_FACTOR
## @brief Normalization factor for the @ref ACD_SIDE_ROW_3 group.
#  Used as a multiplicative factor for the alarm limits.
...
ACD_SIDE_ROW_2_NORM_FACTOR       = ACD_SIDE_ROW_2_TILES_AREA/ACD_NORM_AREA
ACD_SIDE_ROW_3_NORM_FACTOR       = ACD_SIDE_ROW_3_TILES_AREA/ACD_NORM_AREA
...
if __name__ == '__main__':
    ...
    print 'ACD_SIDE_ROW_2_NORM_FACTOR:'      , ACD_SIDE_ROW_2_NORM_FACTOR
    print 'ACD_SIDE_ROW_3_NORM_FACTOR:'      , ACD_SIDE_ROW_3_NORM_FACTOR
