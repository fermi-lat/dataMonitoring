...
if __name__ == '__main__':
    ...
    optparser = pOptionParser('crvVoe',1,1,False)
    ...
    if optparser.Options.r:
        from pFastMonReportGenerator import pStandaloneFastMonReportGenerator
        author = 'Automatically generated by pFastMonTreeProcessor.py'
        reportGenerator = pStandaloneFastMonReportGenerator(\
            optparser.Options.e, optparser.Options.c,\
            treeProcessor.OutputFilePath)
        reportGenerator.MAIN_PAGE_TITLE = 'Fast monitor Tree processor report'
        reportGenerator.REPORT_AUTHOR = author
